...
public class StudentSorterTest {
    ...
    public void givenListShouldReturnSortedListBasedOnAge() {
    ...
    public void givenListShouldReturnSortedListBasedOnId() {

        List<StudentClass> al = new ArrayList<>();

        // create customer objects using constructor initialization
        StudentClass obj1 = new StudentClass(10,"harika",22);
        StudentClass obj2 = new StudentClass(22,"ashritha",23);
        StudentClass obj3 = new StudentClass(13,"ashritha",23);
        StudentClass obj4 = new StudentClass(18,"bhanu",19);
        StudentClass obj5 = new StudentClass(24,"bhanu",19);
        ...
        al.add(obj5);
        Collections.sort(al,new StudentSorter());
        String expected="[StudentClass{id=10, name='harika', age=22}, StudentClass{id=13, name='ashritha', age=23}, StudentClass{id=18, name='bhanu', age=19}, StudentClass{id=22, name='ashritha', age=23}, StudentClass{id=24, name='bhanu', age=19}]";
        assertEquals(expected, al.toString().trim());
